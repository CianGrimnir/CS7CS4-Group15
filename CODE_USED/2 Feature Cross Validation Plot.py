...
@brief: code for plotting cross-validations of two-feature regression models
"""
...
def CrossValPlot(filename1,filename2,years,q1,q2,q3):
    #parse dataset
    filename = filename1+"&"+filename2+"_"+years
...
CrossValPlot("ChildPov16","Rents","2011-2016",1,2,2)
CrossValPlot("Workless","Traffic","2004-2017",1,1,3)